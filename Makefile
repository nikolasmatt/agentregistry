...
help:
	...
	@echo ""
	@echo "Testing:"
	@echo "  test                 - Run Go tests with integration tests"
	...
	@echo "  test-helm            - Run Helm chart unit tests"
	@echo ""
	@echo "Code Quality:"
	@echo "  lint                 - Run golangci-lint (use GOLANGCI_LINT_ARGS=--fix to auto-fix)"
	@echo "  lint-ui              - Run eslint on UI code"
	@echo "  verify               - Verify generated code is up to date"
	@echo "  mod-tidy             - Run go mod tidy"
	@echo ""
	@echo "Generation:"
	@echo "  gen-openapi          - Generate OpenAPI spec"
	@echo "  gen-client           - Generate TypeScript client from OpenAPI spec"
	@echo ""
	@echo "Docker:"
	@echo "  docker               - Build all Docker images"
	@echo "  docker-server        - Build server Docker image"
	@echo "  docker-agentgateway  - Build agent gateway Docker image"
	@echo "  docker-registry      - Start local Docker registry"
	@echo "  docker-compose-up    - Start services with Docker Compose"
	@echo "  docker-compose-down  - Stop Docker Compose services"
	@echo "  docker-compose-rm    - Remove Docker Compose volumes and containers"
	@echo ""
	@echo "Kubernetes:"
	@echo "  create-kind-cluster  - Create a local kind cluster with MetalLB"
	@echo ""
	@echo "Release:"
	@echo "  release-cli          - Build CLI for all platforms with checksums"
